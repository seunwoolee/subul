...
from .views import ProductsAPIView, ProductUpdate, ProductEggUpdate, OrderProductUnitPrice, OrderSetProductMatch, \
    ...
    create_remove_audit, get_audit, check_audit, OrderTimeDatatableList, OrderTimeUpdate
...
urlpatterns = [
    ...
    path('product/deleteSelectedRows', DeleteSelectedRows.as_view()),
    ...
    path('productOrderPackingStock/', ProductOrderPackingStockCreate.as_view()),
    path('productOrderReleaseStock/<int:pk>', ProductOrderReleaseStock.as_view()),
    # OEM쪽 API
    ...
    path('orderPriceMatch/', OrderPriceMatch.as_view()),
    # 출고쪽 API
    ...
    path('releaseOrderCar/', CarDatatableList.as_view()),
    path('releaseOrderLocation/', LocationDatatableList.as_view()),
    path('carCode/<int:pk>', CarCodeUpdate.as_view()),
    # 원란쪽 API
    ...
    path('productCode/', ProductCodeDatatableList.as_view()),
    path('productCode/<int:pk>', ProductCodeUpdate.as_view()),
    path('audit/', create_remove_audit),
    path('get_audit/', get_audit),
    path('checkAudit/', check_audit),
    path('orderTime/', OrderTimeDatatableList.as_view()),
    path('orderTime/<int:pk>', OrderTimeUpdate.as_view()),
